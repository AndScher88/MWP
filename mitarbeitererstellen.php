    ...
    <div class = "container-fluid">
        ...
        <form class = "text-left" action="mitarbeiterneu.php" method="post">
            ...
            <div class="form-row">
                ...
                <div class="col">
                    <input type="text" class="form-control" id="stadt" aria-describedby="stadtlabel" placeholder="Hamburg" required>
                    <label id="stadtlabel" class="form-text text-muted">Stadt</label>
                </div>
                <div class="col">
                    <input type="text" class="form-control" id="postleitzahl1" aria-describedby="postleitzahllabel" placeholder="22880" required>
            ...
            <div class="form-row">
                ...
                <div class="col">
                    <input type="email" class="form-control" id="email" aria-describedby="emaillabel" placeholder="max.mustermann@gmail.com" required>
